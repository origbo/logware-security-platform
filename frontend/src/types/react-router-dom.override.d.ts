/**
 * Complete override for react-router-dom TypeScript declarations
 * This file overrides the conflicting @types/react-router-dom package
 */

declare module '@types/react-router-dom' {
  // This empty declaration will effectively disable the problematic package
}
